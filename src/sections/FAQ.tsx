...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "מרקט-טק היא הגוף המפעיל והסולק עבור המוצרים והשירותים של גובז, א׳-בית (abait.ai), CardDBee, SHAMOOR ו-Planist. לכן שם זה עשוי להופיע בפירוט כרטיס האשראי.",
  },
  {
  ...
  },
  {
    ...
    a: "כיום גובז, א׳-בית (abait.ai), CardDBee, SHAMOOR ו-Planist. בעתיד עשויות להתווסף פלטפורמות נוספות.",
  },
];
